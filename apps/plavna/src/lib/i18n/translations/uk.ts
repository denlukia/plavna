...
export const UK = {
	...
	settings: {
		...
		tips: {
			...
			3: 'Додайте на сторінку секцію і згадайте у її описі теги — статті за згаданими тегами відобразяться у секції. Останні публікації відображатимуться першими'
		}
	}
};
