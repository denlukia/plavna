...
export const getComponentsMap = () => getContext<Readable<ComponentsMap>>(componentsContextKey);
...
export const setAstContext = (value: Readable<HastNode>) => setContext(astContextKey, value);
