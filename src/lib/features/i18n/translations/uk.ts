...
export const UK = {
	...
	main: {
		landing:
			"## Plavna — це сервіс, розроблений мною, Денисом Лук'яненком, для публікації дизайн-фронтенд портфоліо та блогів. \n ## Для авторів це як Medium, де вони можуть налаштувати не лише логотип, а й кольори та естетику, а кожна картка статті може бути кастомним інтерактивним віджетом. \n ## Для читача це як NYT, де можна вимкнути всі нецікаві категорії, та як The Verge, де можна переключитися на більш легку тему. \n ## Для мене це проект, де я намагаюся об'єднати в одному додатку те, чого навчився за роки роботи в дизайні та розробці. \n ## Plavna орієнтована на легкий високоанімований інтерфейс, адже її автор твердо вважає: анімація — не прикраса, а фундаментальна властивість світу.",
